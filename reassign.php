...
<?php
	...
	{
	$requestFromNHName="Opps. Something very rare has occurred. This Profile is not currently assigned to any Neighborhood.  They were already sent to the Re-Assign Queue.  This can happen if the member is sent to the Re-Assign Queue more than once." ; 
	}
